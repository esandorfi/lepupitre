...
use crate::platform::db_helpers;
use crate::platform::seed::QuestSeedFile;
use chrono::Utc;
...
mod tests {
    ...
    fn runs_audio_column_becomes_nullable() {
        ...
        let notnull =
            crate::platform::db_helpers::column_notnull(&conn, "runs", "audio_artifact_id")
                .expect("pragma");
    ...
    fn legacy_profile_schema_upgrades_and_normalizes_orphans() {
        ...
        let has_talk_number =
            crate::platform::db_helpers::column_exists(&conn, "talk_projects", "talk_number")
                .expect("talk_number exists");
        assert!(has_talk_number);
        let has_training_flag =
            crate::platform::db_helpers::column_exists(&conn, "talk_projects", "is_training")
