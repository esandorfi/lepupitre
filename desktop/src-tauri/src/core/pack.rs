...
pub fn peer_review_import(
    ...
    let persist_result = persist_peer_review_import_rows(
        &mut conn,
...
struct PeerReviewImportRows<'a> {
    ...
    transcript_artifact_id: &'a str,
    review_id: &'a str,
    reviewer_tag: Option<&'a str>,
    review_json_artifact_id: &'a str,
}

fn persist_peer_review_import_rows(
    conn: &mut Connection,
