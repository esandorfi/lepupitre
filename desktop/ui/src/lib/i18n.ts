...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "audio.subtitle": "Record a WAV 16kHz mono file locally.",
  ...
  fr: {
    ...
    "nav.talk": "Présentation",
    "home.title": "Accueil",
    "home.subtitle": "Daily quest loop, local-first.",
    "home.talk_title": "Présentation",
    "home.talk_empty": "Aucune présentation active",
    "home.talk_action": "Créer la présentation",
    ...
    "home.quest_empty": "Crée un profil et une présentation pour charger les quêtes.",
    ...
    "talk.active_title": "Présentation active",
    ...
    "audio.subtitle": "Enregistre un WAV mono 16 kHz en local.",
