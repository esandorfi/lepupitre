...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "training.alternate_subtitle": "Use a free quest now. Quest picker and categories come next.",
  ...
  fr: {
    ...
    "training.alternate_subtitle": "Utilise une quête libre maintenant. Le sélecteur de quêtes et les catégories arrivent ensuite.",
