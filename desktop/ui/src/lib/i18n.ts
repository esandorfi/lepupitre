...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.transcription.sidecar_incompatible_label": "Incompatible",
    ...
    "settings.transcription.sidecar_incompatible": "ASR engine is incompatible with this app build. Reinstall or update LePupitre.",
    ...
    "settings.insights.health_title": "Recorder health",
    "settings.insights.health_subtitle": "Operational recorder metrics for local diagnostics.",
    "settings.insights.health_scope": "Local only",
    "settings.insights.health_recordings_started": "Recordings started",
    "settings.insights.health_start_success_rate": "Start success rate",
    "settings.insights.health_stop_failures": "Stop failures",
    "settings.insights.health_transcribe_success_rate": "Transcribe success rate",
    "settings.insights.health_trim_failures": "Trim failures",
    "settings.insights.health_last_error": "Last error code",
    "settings.insights.health_daily_title": "Last 7 days",
    "settings.insights.health_day": "Day",
    "settings.insights.health_daily_recordings": "Recordings",
    "settings.insights.health_daily_stop_fail": "Stop fail",
    "settings.insights.health_daily_transcribe_fail": "Transcribe fail",
    "settings.insights.health_daily_trim_fail": "Trim fail",
    "settings.insights.health_top_errors_title": "Top errors",
    "settings.insights.health_none": "No data yet",
    "settings.insights.health_reset": "Reset health metrics",
    ...
    "settings.recorder.waveform_style_timeline": "Timeline",
    ...
    "audio.quick_clean_playback_title": "Audio playback",
    "audio.quick_clean_playback_hint": "You can always play and scrub the recording while working.",
    "audio.quick_clean_timeline_title": "Timeline markers (every 30s)",
    "audio.quick_clean_timeline_hint": "Click a marker to jump playback to that moment.",
    "audio.quick_clean_timeline_empty": "No transcript chunk available at this time range.",
    "audio.quick_clean_clean_text_title": "Clean text",
    "audio.quick_clean_clean_anchors_title": "Show clean text time anchors",
    "audio.quick_clean_clean_anchors_hint": "Approximate mapping from edited lines to source time windows.",
    "audio.quick_clean_export_anchor_map": "Export anchor map (.json)",
    "audio.quick_clean_export_anchor_map_copied": "Copied to clipboard!",
    "audio.quick_clean_export_anchor_map_hint": "Includes raw chunks, timeline markers, and clean-text anchors.",
    "audio.quick_clean_raw_chunks_title": "Raw text with time chunks (10s)",
    "audio.quick_clean_raw_chunks_hint": "Useful for analysis: each line maps a rough 10-second window.",
    ...
    "audio.quick_clean_trim_advanced_title": "Advanced cut (trim audio)",
    ...
    "audio.announcement_auto_stop_no_signal": "No signal detected. Recording stopped automatically.",
    ...
    "audio.error_sidecar_incompatible": "Transcription engine is incompatible with this app build. Reinstall or update LePupitre.",
    "audio.error_sidecar_incompatible_action": "Open Help",
    ...
    "audio.review_cta_transcribe": "Generate transcription",
    "audio.review_cta_transcribing": "Transcribing...",
    "audio.review_cta_analyze": "Analyze",
    "audio.review_cta_view_feedback": "View feedback",
    "audio.review_cta_export": "Continue to export",
    "audio.review_onboarding_title": "Set context for analysis",
    "audio.review_onboarding_hint": "Optional context to improve feedback quality.",
    "audio.review_onboarding_audience": "Audience",
    "audio.review_onboarding_goal": "Goal",
    "audio.review_onboarding_duration": "Target duration (min)",
    "audio.review_onboarding_skip": "Skip",
    "audio.review_onboarding_audience_team": "Team",
    "audio.review_onboarding_audience_conference": "Conference",
    "audio.review_onboarding_audience_client": "Client",
    "audio.review_onboarding_audience_other": "Other",
    "audio.review_onboarding_goal_inform": "Inform",
    "audio.review_onboarding_goal_persuade": "Persuade",
    "audio.review_onboarding_goal_instruct": "Instruct",
    "audio.review_onboarding_goal_inspire": "Inspire",
    "audio.review_left_title": "Recording",
    "audio.review_right_title": "Transcript workspace",
    "status.idle": "idle",
  ...
  fr: {
    ...
    "settings.transcription.sidecar_incompatible": "Moteur ASR incompatible avec cette version de l'application. Réinstallez ou mettez à jour LePupitre.",
    ...
    "settings.insights.health_title": "Sante du recorder",
    "settings.insights.health_subtitle": "Metriques operationnelles locales pour le diagnostic.",
    "settings.insights.health_scope": "Local uniquement",
    "settings.insights.health_recordings_started": "Enregistrements demarres",
    "settings.insights.health_start_success_rate": "Taux de demarrage reussi",
    "settings.insights.health_stop_failures": "Echecs d'arret",
    "settings.insights.health_transcribe_success_rate": "Taux de transcription reussie",
    "settings.insights.health_trim_failures": "Echecs de trim",
    "settings.insights.health_last_error": "Dernier code erreur",
    "settings.insights.health_daily_title": "7 derniers jours",
    "settings.insights.health_day": "Jour",
    "settings.insights.health_daily_recordings": "Enregistrements",
    "settings.insights.health_daily_stop_fail": "Echecs arret",
    "settings.insights.health_daily_transcribe_fail": "Echecs transcription",
    "settings.insights.health_daily_trim_fail": "Echecs trim",
    "settings.insights.health_top_errors_title": "Top erreurs",
    "settings.insights.health_none": "Pas encore de donnees",
    "settings.insights.health_reset": "Reinitialiser les metriques sante",
    ...
    "settings.recorder.waveform_style_timeline": "Chronologie",
    ...
    "audio.quick_clean_playback_title": "Lecture audio",
    "audio.quick_clean_playback_hint": "La lecture et le deplacement restent disponibles pendant le travail.",
    "audio.quick_clean_timeline_title": "Reperes temporels (toutes les 30s)",
    "audio.quick_clean_timeline_hint": "Clique un repere pour aller directement a ce moment.",
    "audio.quick_clean_timeline_empty": "Aucun segment de transcription pour cette plage de temps.",
    "audio.quick_clean_clean_text_title": "Texte nettoye",
    "audio.quick_clean_clean_anchors_title": "Afficher les reperes temporels du texte nettoye",
    "audio.quick_clean_clean_anchors_hint": "Correspondance approximative entre lignes modifiees et temps source.",
    "audio.quick_clean_export_anchor_map": "Exporter la carte d'ancrage (.json)",
    "audio.quick_clean_export_anchor_map_copied": "Copie dans le presse-papiers !",
    "audio.quick_clean_export_anchor_map_hint": "Inclut chunks bruts, reperes temporels et ancres du texte nettoye.",
    "audio.quick_clean_raw_chunks_title": "Texte brut avec reperes (10s)",
    "audio.quick_clean_raw_chunks_hint": "Utile pour l'analyse: chaque ligne couvre environ 10 secondes.",
    ...
    "audio.quick_clean_trim_advanced_title": "Coupe avancee (rogner l'audio)",
    ...
    "audio.announcement_auto_stop_no_signal": "Aucun signal detecte. Enregistrement arrete automatiquement.",
    ...
    "audio.error_sidecar_incompatible": "Moteur de transcription incompatible avec cette version de l'application. Réinstallez ou mettez à jour LePupitre.",
    "audio.error_sidecar_incompatible_action": "Ouvrir l'aide",
    ...
    "audio.review_cta_transcribe": "Générer la transcription",
    "audio.review_cta_transcribing": "Transcription en cours...",
    "audio.review_cta_analyze": "Analyser",
    "audio.review_cta_view_feedback": "Voir le feedback",
    "audio.review_cta_export": "Continuer vers l'export",
    "audio.review_onboarding_title": "Définir le contexte pour l'analyse",
    "audio.review_onboarding_hint": "Contexte optionnel pour améliorer la qualité du feedback.",
    "audio.review_onboarding_audience": "Audience",
    "audio.review_onboarding_goal": "Objectif",
    "audio.review_onboarding_duration": "Durée cible (min)",
    "audio.review_onboarding_skip": "Passer",
    "audio.review_onboarding_audience_team": "Équipe",
    "audio.review_onboarding_audience_conference": "Conférence",
    "audio.review_onboarding_audience_client": "Client",
    "audio.review_onboarding_audience_other": "Autre",
    "audio.review_onboarding_goal_inform": "Informer",
    "audio.review_onboarding_goal_persuade": "Convaincre",
    "audio.review_onboarding_goal_instruct": "Instruire",
    "audio.review_onboarding_goal_inspire": "Inspirer",
    "audio.review_left_title": "Enregistrement",
    "audio.review_right_title": "Espace transcription",
    "status.idle": "inactif",
