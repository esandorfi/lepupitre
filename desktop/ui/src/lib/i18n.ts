...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.transcription.model_note": "Tiny is bundled. Base is an optional upgrade.",
    ...
    "settings.transcription.download_note": "Download support is planned in a later pass.",
    "home.title": "Home",
  ...
  fr: {
    ...
    "settings.transcription.model_note": "Tiny est inclus. Base est une mise à niveau optionnelle.",
    "settings.transcription.mode_label": "Mode",
    "settings.transcription.mode_auto": "Auto (benchmark tiny)",
    "settings.transcription.mode_live_final": "Live + final",
    ...
    "settings.transcription.download_note": "Le téléchargement arrive dans une prochaine passe.",
    "home.title": "Accueil",
