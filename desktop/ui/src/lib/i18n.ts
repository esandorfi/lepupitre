...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "talk_report.recent_attempts": "Recent attempts",
    "talk_report.no_attempts": "No attempts yet.",
    "talk_report.replay": "Replay",
  ...
  fr: {
    ...
    "talk_report.recent_attempts": "Tentatives récentes",
    "talk_report.no_attempts": "Pas encore de tentative.",
    "talk_report.replay": "Rejouer",
    "feedback.title": "Feedback",
