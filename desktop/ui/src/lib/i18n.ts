...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "audio.quick_clean_trim_title": "Trim audio (preview)",
    "audio.quick_clean_trim_hint": "Adjust start/end handles now. Applying trim is in the next slice.",
    "audio.quick_clean_trim_unavailable": "Audio duration is unavailable for trim preview.",
  ...
  fr: {
    ...
    "audio.quick_clean_trim_title": "Rogner l'audio (apercu)",
    "audio.quick_clean_trim_hint": "Ajuste les bornes debut/fin maintenant. L'application du rognage arrive dans la prochaine etape.",
    "audio.quick_clean_trim_unavailable": "La duree audio est indisponible pour l'apercu de rognage.",
