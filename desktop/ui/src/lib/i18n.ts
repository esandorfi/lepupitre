...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "home.profile_manage_copy": "Open the Espaces page to create, rename, or delete workspaces.",
    ...
    "talk.goto_profiles": "Go to Espaces",
    ...
    "boss_run.setup_profile": "Go to Espaces",
    ...
    "builder.setup_profile": "Go to Espaces",
    ...
    "packs.setup_profile": "Go to Espaces",
