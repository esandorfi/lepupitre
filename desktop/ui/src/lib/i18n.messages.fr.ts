export const frMessages = {
    ...
    "nav.voice_recorder": "Dictaphone",
    "voice_recorder.title": "Dictaphone",
    "voice_recorder.page_title": "Dictaphone",
    "voice_recorder.page_subtitle": "Enregistre, écoute et gère tes mémos vocaux.",
    "voice_recorder.need_profile": "Crée un espace avant d'enregistrer.",
    "voice_recorder.setup_profile": "Ouvrir les espaces",
    "voice_recorder.status_ready": "PRÊT",
    "voice_recorder.status_rec": "REC",
    "voice_recorder.status_paused": "PAUSE",
    "voice_recorder.memos_title": "Mémos vocaux",
    "voice_recorder.no_memos": "Aucun mémo vocal pour le moment.",
    "voice_recorder.play_memo": "Lire le mémo",
    "voice_recorder.pause_memo": "Mettre en pause",
    "voice_recorder.delete_memo": "Supprimer le mémo",
    "voice_recorder.confirm_delete": "Supprimer",
    "voice_recorder.cancel": "Annuler",
    ...
    "audio.playback_buffering": "Preparation de la lecture...",
    ...
    "audio.announcement_stopping": "Finalisation de l'enregistrement...",
    ...
    "audio.finalizing_title": "Finalisation de l'enregistrement",
    "audio.finalizing_hint": "Sauvegarde de l'audio et preparation de l'aperçu. Encore quelques secondes.",
