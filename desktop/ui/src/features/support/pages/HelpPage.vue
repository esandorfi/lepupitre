    ...
    <AppPanel>
      ...
      <div class="mt-3 grid gap-3 lg:grid-cols-2">
        <AppPanel as="article" class="app-radius-panel-lg" variant="compact">
          ...
          <pre class="app-card app-radius-panel-md mt-3 overflow-x-auto border p-3 text-xs">{{ t("help.dev_ui_only_command") }}</pre>
        </AppPanel>
        <AppPanel as="article" class="app-radius-panel-lg" variant="compact">
          <h3 class="app-text text-sm font-semibold">{{ t("help.dev_tauri_title") }}</h3>
          <p class="app-muted mt-2 text-sm">{{ t("help.dev_tauri_body") }}</p>
          <pre class="app-card app-radius-panel-md mt-3 overflow-x-auto border p-3 text-xs">{{ t("help.dev_tauri_command") }}</pre>
        </AppPanel>
      </div>
    </AppPanel>
