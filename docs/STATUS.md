...
| [docs/plan/PLAN-UI-FEATURE-STRUCTURE-NUXT-MIGRATION.md](plan/PLAN-UI-FEATURE-STRUCTURE-NUXT-MIGRATION.md) | UI feature-folder restructuring + Nuxt UI migration execution plan | implemented | UI/Maintainers | Completed on 2026-03-04; keep second-pass Nuxt UI drift checks in routine validation |
