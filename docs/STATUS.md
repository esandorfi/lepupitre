...
| [docs/plan/PLAN-TALKS-VUE3-SOTA.md](plan/PLAN-TALKS-VUE3-SOTA.md) | Talks feature Vue 3 SOTA maintainability/performance execution plan | implemented | UI/Maintainers | Keep architecture checklist and talks runtime test obligations enforced on future talks changes |
