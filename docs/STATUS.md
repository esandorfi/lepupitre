...
| [docs/plan/PLAN-TAURI-SQL-HARDENING.md](plan/PLAN-TAURI-SQL-HARDENING.md) | SQLite hardening execution plan | in_progress | Maintainers | Continue Workstream 6 (CI failure thresholds + explicit runbook links) |
