...
| [docs/plan/PLAN-TAURI-SQL-HARDENING.md](plan/PLAN-TAURI-SQL-HARDENING.md) | SQLite hardening execution plan | in_progress | Maintainers | Continue Workstream 2 (migration tracking + continuity) and promote implemented rules to canonical docs |
