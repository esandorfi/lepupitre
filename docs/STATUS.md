...
| [docs/plan/PLAN-ASR-OPS-VERIFICATION.md](plan/PLAN-ASR-OPS-VERIFICATION.md) | ASR ops verification and diagnostics hardening | proposed | ASR maintainers | Deliver Phase 1 (`--version`, `doctor --json`, app compatibility parse) |
...
| [docs/plan/PLAN-RECORDER-AUDIO-SOTA.md](plan/PLAN-RECORDER-AUDIO-SOTA.md) | Recorder-first audio architecture hardening plan | proposed | UI/ASR maintainers | Execute Phase 1 and Phase 2 (quick record entrypoint + record-only UX contract) |
