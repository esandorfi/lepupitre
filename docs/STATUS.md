...
| [docs/plan/PLAN-TAURI-SQL-HARDENING.md](plan/PLAN-TAURI-SQL-HARDENING.md) | SQLite hardening execution plan | in_progress | Maintainers | Finalize Workstream 2 with upgrade-path fixture coverage, then proceed to Workstream 3 (FK + transactions) |
