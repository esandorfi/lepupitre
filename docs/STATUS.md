...
| [docs/plan/PLAN-TALKS-VUE3-SOTA.md](plan/PLAN-TALKS-VUE3-SOTA.md) | Talks feature Vue 3 SOTA maintainability/performance execution plan | in_progress | UI/Maintainers | Keep governance rollout stable and enforce guard-layering + G1/G2 + JSDoc (9.3) + page composition header (9.4) policies on new talks changes |
