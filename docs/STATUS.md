...
| [docs/plan/PLAN-TALKS-VUE3-SOTA.md](plan/PLAN-TALKS-VUE3-SOTA.md) | Talks feature Vue 3 SOTA maintainability/performance execution plan | in_progress | UI/Maintainers | Keep governance rollout stable and enforce G1/G2 comment-threshold policy on new talks runtime/action changes |
