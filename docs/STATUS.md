...
| [docs/plan/PLAN-RECORDER-WAVEFORM-UX-POLISH.md](plan/PLAN-RECORDER-WAVEFORM-UX-POLISH.md) | Deferred recorder enhancements (waveform + polish) | in_progress | UI/ASR maintainers | Run full Rust validation gate and close plan |
