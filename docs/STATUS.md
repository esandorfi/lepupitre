...
| [docs/plan/PLAN-UI-FEATURE-RULES-ROLLOUT.md](plan/PLAN-UI-FEATURE-RULES-ROLLOUT.md) | Cross-feature rollout of talks-proven page/state/i18n composition rules | in_progress | UI/Maintainers | Keep new/touched non-talk pages aligned on single-`vm` consumption, page-local i18n ownership, and composition-root header contract |
