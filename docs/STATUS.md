...
| [spec/active/ui/SPEC-UI-RUNTIME-INPUT-CONTRACT.md](../spec/active/ui/SPEC-UI-RUNTIME-INPUT-CONTRACT.md) | Runtime composable input contract refactor proposal | accepted | UI/Maintainers | Keep runtime command contract + test obligations enforced for newly touched modules |
