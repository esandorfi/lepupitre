...
check_forbidden_match \
  ...
  'crate::core::(run|coach|preferences|workspace|project|outline|feedback|quest|pack|peer_review|recorder|recording|asr|asr_live|asr_models|asr_sidecar|db|db_helpers|seed|dsp|vad)' \
